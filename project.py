...
def fbconnect():
    ...
    '''
        ...
        split the token first on commas
         and select the first index which
         gives us the key : value
        for the server access token then
...
def getUserInfo(user_id):
    ...
    for category in categories:
        print(category.user_id, category.name, category.id)
...
def showItems(category_id):
    ...
    for item in items:
        print(item.name, item.category_id, item.description, item.user_id)
